...
public class LordVillager {
    public static final PointOfInterestType LORD_POI = registerPOI("lord_poi", ModBlocks.BLOCK_URANIUM);
    ...
    public static void registerVillagers () {
        modloader.LOGGER.info("Registering Villagers for " + modloader.MOD_ID);
    }
